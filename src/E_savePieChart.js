...
let E_gaolChart1 = new Chart(E_goal1, config1);
let E_gaolChart2 = new Chart(E_goal2, config2);
let E_gaolChart3 = new Chart(E_goal3, config3);
let E_gaolChart4 = new Chart(E_goal4, config4);
